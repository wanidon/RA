...
This tool simulates calling function which may cause re-enctancy attack, and detect it. This can also verify construction of new contract as external calling.
## Requirement
